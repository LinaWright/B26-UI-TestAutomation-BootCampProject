             ...
             */
                switch (browserType) {
                    ...
                    case "remote-chromeSSL":
                        ...
                        try{
                            driverPool.set(new RemoteWebDriver(new URL("https://oauth-linaliwright-fa15b:f0dfbd04-881b-4ee6-9477-9e62d1f31a9b@ondemand.us-west-1.saucelabs.com:443/wd/hub"),remoteCapability));
